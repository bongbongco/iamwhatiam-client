...
import HavrutaPresenter from "./HavrutaPresenter";
import { GET_NEARBY_DRIVERS, REPORT_LOCATION } from "./HavrutaQueries";
...
class HavrutaContainer extends React.Component<IProps, IState> {
    public mapRef: any;
